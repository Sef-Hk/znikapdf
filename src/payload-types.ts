...
export interface Config {
  ...
  globalsSelect: {
    ...
    pdfmanager: PdfmanagerSelect<false> | PdfmanagerSelect<true>;
  };
  locale: null;
  user: User & {
    collection: 'users';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "pdfmanager".
 */
export interface Pdfmanager {
  id: number;
  /**
   * Upload the logo that will be displayed on the page.
   */
  logo?: (number | null) | Media;
  /**
   * Upload the PDF that will be shown on the page.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "pdfmanager_select".
 */
